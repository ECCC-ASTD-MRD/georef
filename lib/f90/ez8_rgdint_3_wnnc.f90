...
! */
      subroutine ez8_rgdint_3_wnnc(zo,px,py,npts,z,ni,j1,j2,wrap)
!*******
...
#include "cubic8.cdk"
      ...
      !$OMP PARALLEL DO DEFAULT(NONE) PRIVATE(n,i,j,imoins1,iplus1,iplus2,dx,dy,y1,y2,y3,y4) SHARED(npts,j1,j2,ni,px,py,wrap,z,zo,limite)
      do n=1,npts
