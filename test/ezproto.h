...
extern int  c_ezsint(ftnfloat *zout, ftnfloat *zin, TGeoRef* gdout, TGeoRef* gdin);
extern int  c_ezuvint(ftnfloat *uuout, ftnfloat *vvout, ftnfloat *uuin, ftnfloat *vvin, TGeoRef* gdout, TGeoRef* gdin);
extern int  c_ezwdint(ftnfloat *uuout, ftnfloat *vvout, ftnfloat *uuin, ftnfloat *vvin, TGeoRef* gdout, TGeoRef* gdin);
