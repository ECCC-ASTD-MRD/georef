...
#include "GeoRef.h"
#include "georef/GeoRef_Type_Q.h"
...
int test_cubed_sphere(void) {
    ...
    Lib_Log(APP_LIBGEOREF, APP_INFO, "%s: Checking XY2LL\n", __func__);
    {
        ...
        const int num_converted = GeoRef_XY2LL_Q(ref, lat, lon, grid_x, grid_y, num_total);
    ...
    Lib_Log(APP_LIBGEOREF, APP_INFO, "Checking LL2XY\n");
    {
        ...
        const int num_converted = GeoRef_LL2XY_Q(ref, grid_back_x, grid_back_y, ref->Lat, ref->Lon, num_total);
    ...
    Lib_Log(APP_LIBGEOREF, APP_INFO, "%s: Checking LL interp\n", __func__);
    {
        ...
        App_TimerStart(&t1);
        if (GeoRef_XY2LL_Q(ref, lat, lon, x, y, num_samples * num_samples) != num_samples * num_samples) {
