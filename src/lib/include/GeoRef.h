...
int32_t ComputeLinearInterpIndicesQ(TGeoRef *Ref, const double* X, const double* Y, const int32_t NumPoints,
                                    float indices[][6]);
void ApplyLinearInterpQ_32(const float indices[][6], const int32_t NumPoints, const float NoData,
