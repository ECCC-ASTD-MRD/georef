...
#include "zlin.cdk"
      ...
      if (ordint.eq.cubique) then
         do 10 n=1,npts
            ...
            a13 = fa3((1.0/(ax(i)-ax(i-1))),1.0/(ax(i+1)-ax(i-1)), &
               1.0/(ax(i+1)-ax(i)),z(i-1),z(i),z(i+1))
            a14 = fa4((1.0/(ax(i)-ax(i-1))),1.0/(ax(i+1)-ax(i-1)), &
               1.0/(ax(i+1)-ax(i)),1.0/(ax(i+2)-ax(i-1)),1.0/(ax(i+2)-ax(i)),1.0/(ax(i+2)-ax(i+1)),z(i-1),z(i),z(i+1),z(i+2))
