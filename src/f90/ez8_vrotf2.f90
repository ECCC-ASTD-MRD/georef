...
!
      subroutine ez8_vrotf2(u, v, lonp, latp, lon, lat, ro, xyz, uvcart, ni, nj)
      implicit none
      integer ni, nj 
      real*8 lonp(ni,nj), lon(ni,nj), uvcart(3,ni*nj), latp(ni,nj), lat(ni,nj), xyz(3,ni*nj)
      real    u(ni,nj), ro(3,3), v(ni,nj)
!
