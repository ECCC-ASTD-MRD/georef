...
! */
!**s/r ez8_ll2igd - conversion de coordonnees lat-lon a pts de grille

      subroutine ez8_ll2igd(px,py,xlat,xlon,npts,ni,nj,grtyp,grref,ig1,ig2,ig3,ig4,ax,ay,coordflag)
      implicit none
#include "qqqpar.cdk"
      ...
      if (grref.eq.'L') then
         ...
         call ez8_llll2gd(px,py,xlat,xlon,npts,xlat0,xlon0,dlat,dlon,lonref)
         do i=1,npts
            px(i) = px(i)-1.0
            py(i) = py(i)-1.0
         enddo
