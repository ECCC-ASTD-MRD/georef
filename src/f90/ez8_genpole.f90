...
!**
!**
      subroutine ez8_genpole(vpolnor,vpolsud,fld,ni,nj,vecteur,grtyp,hem,x,y,z,lat,lon,glat,ordint)
      implicit none
      ...
      logical vecteur   
      integer hem,ordint
      real*8 x(2,ni),y(2,ni),lat(2,ni),lon(2,ni)
      ! TODO Maude: Is z a real or real*8
      real z(2,ni),glat(*)
...
!      endif
      ...
      do n=1,2
         ...
         pi = 0.0
         pj = 0.0
         call ez8_vxyfll(x,y,lat,lon,2*ni,1000.0,0.0,pi,pj,n)
         ...
         if (ordint.eq.lineair) then
            ...
            deta = b(1)*(a(2,2)*a(3,3)-a(3,2)*a(2,3))   - a(2,1)*(b(2)*a(3,3)-a(3,2)*b(3))     &
               + a(3,1)*(b(2)*a(2,3)-a(2,2)*b(3))
            detb = a(1,1)*(b(2)*a(3,3)-a(3,2)*b(3))     - b(1)*(a(1,2)*a(3,3)-a(3,2)*a(1,3))   &
               + a(3,1)*(a(1,2)*b(3)-b(2)*a(1,3))
            detc = a(1,1)*(a(2,2)*b(3)-b(2)*a(2,3))     - a(2,1)*(a(1,2)*b(3)-b(2)*a(1,3))     &
              + b(1)*(a(1,2)*a(2,3)-a(2,2)*a(1,3))
