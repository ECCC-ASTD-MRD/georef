...
!
      subroutine ez8_llwfgfw(spd,dir,xlat,xlon,li,lj,grtyp,ig1,ig2,ig3,ig4)

      implicit none
      integer li,lj
      real spd(li,lj), dir(li,lj)
      real*8 xlat(li,lj),xlon(li,lj)
      character*1 grtyp
...
!
      ...
      real*8 :: xlatgf(li,lj),xlongf(li,lj)
