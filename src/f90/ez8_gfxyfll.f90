...
! */
!**s/r ez8_gfxyfll - compute a latitude and longitude on the true earth from a 
!		 x and y coordinate on a rotated latitude/longitude frame
!		 of reference.
!
      subroutine ez8_gfxyfll(lonp,latp,lon,lat,n,xlat1,xlon1,xlat2,xlon2)
      implicit none
      integer n
      real xlon1,xlat2,xlat1,xlon2
      real*8 lonp(n),latp(n),lon(n),lat(n)
!     
!
