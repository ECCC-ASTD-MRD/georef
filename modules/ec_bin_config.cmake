...
install(CODE "execute_process(COMMAND sed -e \"s/CMAKE_CC/\\\"${CMAKE_C_COMPILER_ID} ${CMAKE_C_COMPILER_VERSION}\\\"/\" -e \"s/CMAKE_FTN/\\\"${CMAKE_Fortran_COMPILER_ID} ${CMAKE_Fortran_COMPILER_VERSION}\\\"/\" 
   ...
   -e \"s/CMAKE_RMN/${RMN_VERSION}${RMN_STATE}/\" -e \"s/CMAKE_VGRID/${VGRID_VERSION}${VGRID_STATE}/\"
   -e \"s/CMAKE_GDAL/${GDAL_VERSION}/\" -e \"s/CMAKE_NETCDF/${NETCDF_VERSION}/\" -e \"s/CMAKE_HDF4/${HDF4_VERSION}/\" -e \"s/CMAKE_HDF5/${HDF5_VERSION}/\"
