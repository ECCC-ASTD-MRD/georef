...
function(ec_build_include)
   ...
   FILE (APPEND ${CMAKE_BINARY_DIR}/timestamp.cmake "file(WRITE build.h \"#ifndef _TIMESTAMP_H\\n\")\n")
   FILE (APPEND ${CMAKE_BINARY_DIR}/timestamp.cmake "file(APPEND build.h \"#define _TIMESTAMP_H\\n\\n\")\n")
   ...
   FILE (APPEND ${CMAKE_BINARY_DIR}/timestamp.cmake "file(APPEND build.h \"#endif // _TIMESTAMP_H\\n\")\n")
   ADD_CUSTOM_TARGET (
      timestamp
...
macro(ec_parse_version)
 ...
 #     message("${CMAKE_MATCH_1}..${CMAKE_MATCH_2}..${CMAKE_MATCH_3}")
      ...
      if (${CMAKE_MATCH_2} MATCHES ":")
         ...
         if ("${line}")
            set(${LBL1}_REQ_VERSION_CHECK ${CMAKE_MATCH_2})
   
            string(REGEX MATCH "([0-9]+)\\.([0-9]+)\\.([0-9]+)" null ${CMAKE_MATCH_3})
