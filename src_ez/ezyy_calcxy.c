...
wordint c_ezyy_calcxy(TGeoRef *gdout,TGeoRef *gdin)
{
   ...
   /* destination grid is one grid */ 
   {
      ...
      icode = c_ezyymint(yin_gdout, yin_gdin, ni, nj, gdout->gset[idx_gdin].yin_maskout,
                         gdout->gset[idx_gdin].yinlat, gdout->gset[idx_gdin].yinlon,
                         yin2yin_lat, yin2yin_lon, &yincount_yin, yan2yin_lat, yan2yin_lon, &yancount_yin);
