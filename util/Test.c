...
int main(int argc, char *argv[]) {
   ...
   for(i=0;i<10;i++) {
      App_Log(APP_INFO|APP_ONCE,"Test log once, this should appear only once\n");
      App_Log(APP_ERROR,"Test more than once, this should appear 10 times\n");
      App_Log(APP_DEBUG|APP_ONCE,"Test log once, this should alsoe appear only once\n");
   }
